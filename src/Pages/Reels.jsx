  ...
  return (
    <div>
      <Swiper
        ...
        className="Reels h-[93.2vh] w-full bg-amber-0 relative"
      >
        {mixedArray.map((elem, index) => {
          return (
            <SwiperSlide  className="Reel relative h-full w-full ">
              ...
              <div className="icons right-2 top-[52.8%] absolute  b z-[100] flex items-center justify-between gap-1 flex-col ">
              ...
              <div className="bottom-bar z-[100] absolute bottom-4 flex flex-col items-start  w-full  ">
