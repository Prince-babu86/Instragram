...
const Menubar = () => {
  ...
  return (
    <div>
      <menu className='flex fixed bottom-0 bg-black items-center justify-between w-full z-[101] px-6 py-3 border-t-[0.5px]'>
        ...
        <Link onClick={onReloadpage}  to={`/Reel`} className="menu-item">
        ...
        <div className="menu-item">
       <img className='w-[27px] h-[27px] object-top rounded-full' src="https://i.pinimg.com/736x/93/54/5f/93545f9ade25d6c5e491d0b3d7ce5369.jpg" alt="" />
        </div>
      </menu>
