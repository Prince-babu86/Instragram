...
const Feed = () => {
  ...
  return (
    <div>
        {isLoader ? (users.map((elem,id)=>{
            return <FeedLoader/>
        })):(users.map((elem , id)=>{
            return <div>
            <div className="feed w-full bg-red-40 mb-4">
              <div className="relative">
                <div className="fd-user p-2 flex items-center gap-2 relative z-10">
                  <img
                    className="h-10 w-10 rounded-full"
                    src="https://i.pinimg.com/736x/9e/bd/d2/9ebdd20e10b419d49aa5fdd554751ee1.jpg"
                    alt=""
                  />
                  <div className="flex items-start justify-center flex-col">
                    <h4 className="text-sm">username</h4>
                    <h4 className="text-[11px]">rajsthan</h4>
                  </div>
                ...
                <div className=" top-0  w-full">
                  <img className="w-full h-full"
                    src="https://i.pinimg.com/736x/05/0d/ce/050dced012802733a5007424747f18fa.jpg"
                    alt=""
                  />
                </div>
              ...
              <div className="fd-sharesection flex items-center justify-between px-3 z-20 mt-3">
                  <div className="flex items-center  gap-4  ">
                      <div className="fd-sd flex items-center gap-1">
                          ...
                          <h4 className="text-[13px]">2000</h4>
                      </div>
                      <div className="fd-sd flex items-center gap-1">
                          <div><svg aria-label="Comment" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Comment</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg></div>
                          <h4 className="text-[13px]">2000</h4>
                      </div>
                      <div className="fd-sd flex items-center gap-1">
              ...
              <div className="fd-comment px-3 mt-2">
                  <p className="text-[12px]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam, iure.</p>
              </div>
